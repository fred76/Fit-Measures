...
class PlicheMoethodController: UIViewController , UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIPopoverPresentationControllerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let cell = collectionView.cellForItem(at: indexPath) as? PlicheMetCollectionViewCell {
            ...
            let customAlert = self.storyboard?.instantiateViewController(withIdentifier: "CustomAlertIDPlico") as! AllertViewPlicoInsert
...
extension PlicheMoethodController : CustomAlertViewDelegateThreeTextField {
...
extension PlicheMoethodController : CustomAlertViewMassGraphDelegate {
    func okAcceptMesure() {
        triceps = nil
        suprailiac = nil
        thigh = nil
